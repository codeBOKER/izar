        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-right mb-10 md:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-darkblue mb-6">
              ...
              <span className="text-navy">بجودة استثنائية</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 sm:space-x-reverse">
              <Link to="/products">
                <Button className="bg-darkblue hover:bg-navy text-white px-8 py-3 rounded-md text-lg">
                  تسوق الآن
                </Button>
              </Link>
              <Link to="/about">
                <Button variant="outline" className="border-darkblue text-darkblue hover:bg-darkblue hover:text-white px-8 py-3 rounded-md text-lg">
                  اكتشف المزيد
                </Button>
              </Link>
            </div>
          ...
          <div className="md:w-1/2 relative">
            <div className="relative h-64 sm:h-80 md:h-96 w-full bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="absolute top-4 right-4 bg-darkblue text-white text-sm py-1 px-3 rounded-full">
                منتجات عالية الجودة
              </div>
            </div>
            <div className="absolute -bottom-6 -left-6 h-24 w-24 rounded-full bg-navy flex items-center justify-center text-white text-center p-2">
              <div>
